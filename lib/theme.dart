...
const kDarkBoxColor = Color.fromRGBO(32, 41, 46, 1);
const kLightBgColor = Color.fromRGBO(255, 255, 255, 1);
const kTextHighlightColor = Color.fromRGBO(18, 140, 126, 1);
...
const kSenderMessageColorDark = Color.fromRGBO(58, 113, 253, 1);
...
final darkTheme = ThemeData.dark().copyWith(
  ...
  dialogBackgroundColor: kDarkBoxColor,
);
